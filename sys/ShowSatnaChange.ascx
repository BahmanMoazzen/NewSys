<%@ Control Language="C#" ClassName="ShowSatnaChange" %>
...
<script runat="server">
    ...
    {
        gvw.DataSource = AB.System.SATNA.SatnaGroupChange;
        gvw.DataBind();
    }
    protected void gvw_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        AB.System.SATNA.RegisterSatnaMember(bid, pid);
        loadData();
    }
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gvw" runat="server" AllowPaging="True" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="roleName" HeaderText="نقش" ReadOnly="True" />

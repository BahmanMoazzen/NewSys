<%@ Control Language="C#" ClassName="OffBranchReport" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LoginSystem1.CheckSecurity("1_5_", mvw, vwPage, vwLogin);
    ...
    protected void vwPage_Activate(object sender, EventArgs e)
    {
        ...
        blBranches.BID = AB.user.BID;
        blBranches.Enabled = false;
...
<asp:MultiView ID="mvw" runat="server" ActiveViewIndex="0">
    ...
    <asp:View ID="vwPage" runat="server" onactivate="vwPage_Activate">
        <uc2:tabletitle ID="tabletitle2" runat="server" Text="گزارش مرخصي - مخصوص شعبه" 
            Icon="0" />
        <br />
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="20%">
                            <asp:Label ID="Label8" runat="server" CssClass="FormCaption" Text="كارمند:"></asp:Label>
                        </td>
                        <td width="20%">
                            <asp:Label ID="Label9" runat="server" CssClass="FormCaption" Text="شعبه:"></asp:Label>
                        </td>
                        <td width="20%">
                        ...
                        <td width="20%">
                            <asp:Label ID="Label12" runat="server" CssClass="FormCaption" Text="نوع مرخصي:"></asp:Label>
                        </td>
                        <td width="25%">
                            <asp:Label ID="Label13" runat="server" CssClass="FormCaption" Text="وضعيت:"></asp:Label>
                        </td>
                    </tr>
                    <tr valign="top">
                        <td>
                ...
                <asp:GridView ID="gvw" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="محل ثبت">
                            <ItemTemplate>
                                <asp:Literal ID="litBName" runat="server" Text='<%# Eval("bname") %>'></asp:Literal>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Literal ID="litBNameEdite" runat="server" Text='<%# Eval("bname") %>'></asp:Literal>
                            </EditItemTemplate>
                        </asp:TemplateField>

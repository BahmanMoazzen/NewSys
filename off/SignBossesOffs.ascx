<%@ Control Language="C#" ClassName="SignBossesOffs" %>
...
<script runat="server">
    ...
    protected void loadData()
    {
        ...
        gvw.DataSource = AB.Offs.BossOffsToSign();
        gvw.DataBind();
    ...
    {
        Page.Title = "ليست مرخصي هاي جديد رؤساي شعب جهت امضاء :: " + Page.Title;
        LoginSystem1.CheckSecurity("1_14_", mvw, vwPage, vwLogin);
...
<asp:MultiView ID="mvw" runat="server" ActiveViewIndex="0">
    ...
    <asp:View ID="vwPage" runat="server" onactivate="vwPage_Activate">
        <uc2:tabletitle ID="tabletitle2" runat="server" Text="فهرست مرخصي هاي جديد رؤساي شعب جهت امضاء" 
            Icon="0" />
        <br />
        <br />
        <br />

...
<script runat="server">
    ...
    {
        Page.Title = "گزارش مقایسه ای معوقات :: " + Page.Title;
        LoginSystem1.CheckSecurity("1_47_", mvw, vwPage, vwLogin);
    ...
    {
        gvw.DataSource = AB.Vosool.ComparativeReport(pdpStart.GeorgianDate,pdpEnd.GeorgianDate);
        gvw.DataBind();
    }
</script>
            ...
            <tr>
                <td>
                    <uc2:tableTitle ID="tableTitle1" runat="server" Icon="1" 
                        ...
                        Text="گزارش مقایسه ای معوقات عقود مبادله ای" />
                </td>
            </tr>
            <tr>
                <td>

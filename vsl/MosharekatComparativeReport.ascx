...
<script runat="server">
    ...
    {
        Page.Title = "گزارش مقایسه ای معوقات مشارکت :: " + Page.Title;
        LoginSystem1.CheckSecurity("1_52_", mvw, vwPage, vwLogin);
    ...
    {
        gvw.DataSource = AB.Vosool.MosharekatComparativeReport(pdpStart.GeorgianDate, pdpEnd.GeorgianDate);
        gvw.DataBind();
    }
</script>
            ...
            <tr>
                <td>
                    <uc2:tableTitle ID="tableTitle1" runat="server" Icon="1" 
                        SubText="تاریخ مورد نظر خود را وارد نموده و کلید نمایش را فشار دهید. دقت کنید که ابتدا تاریخ کمتر و بعد تاریخ بیشتر را وارد نمایید." 
                        Text="گزارش مقایسه ای معوقات عقود مشارکتی" />
                </td>
            </tr>
            <tr>
                <td>

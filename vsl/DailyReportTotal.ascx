...
<script runat="server">
    ...
    {
        Page.Title = "گزارش روزانه معوقات به تفکیک مهر :: " + Page.Title;
        LoginSystem1.CheckSecurity("1_46_", mvw, vwPage, vwLogin);
    ...
    {
        gvw.DataSource = AB.Vosool.DailyReportTotalByDate(pdpStart.GeorgianDate);
        gvw.DataBind();
    }
</script>
            ...
            <tr>
                <td>
                    <uc2:tableTitle ID="tableTitle2" runat="server" Icon="1" 
                        ...
                        Text="آمار مطالبات مبادله ای معوق به تفکیک مهر" />
                </td>
            </tr>
            <tr>
                <td>

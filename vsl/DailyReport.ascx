...
<script runat="server">
    ...
    {
        Page.Title = "گزارش روزانه معوقات :: " + Page.Title;
        LoginSystem1.CheckSecurity("1_45_", mvw, vwPage, vwLogin);
    ...
    {
        gvw.DataSource = AB.Vosool.DailyReportByDate(pdpStart.GeorgianDate);
        gvw.DataBind();
    }
</script>
            ...
            <tr>
                <td>
                    <uc2:tableTitle ID="tableTitle1" runat="server" Icon="1" 
                        ...
                        Text="آمار مطالبات مبادله ای معوق" />
                </td>
            </tr>
            <tr>
                <td>

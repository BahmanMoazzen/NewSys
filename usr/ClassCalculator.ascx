<%@ Control Language="C#" ClassName="ClassCalculator" %>
    ...
    <asp:GridView ID="gvwLatest" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="شماره استخدامي">
                ...
                <ItemTemplate>
                    <asp:Label ID="lblPID1" runat="server" Text='<%# Eval("PID") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="تاريخ تولد">
                <EditItemTemplate>
                    <uc1:persianDatePicker ID="pdpDOB" GeorgianDate='<%# DateTime.Parse(Eval("DOB").ToString()) %>' runat="server" />
                </EditItemTemplate>
                <ItemTemplate>
                    <uc3:persiandatebinder ID="pdbDOB" Date='<%# DateTime.Parse(Eval("DOB").ToString()) %>' runat="server" />
                </ItemTemplate>
                <ItemStyle Wrap="False" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="تاريخ استخدام">
                <EditItemTemplate>
                    <uc1:persianDatePicker ID="pdpDOE" GeorgianDate='<%# DateTime.Parse(Eval("DOE").ToString()) %>' runat="server" />
                    <br />
...
<p>
    ...
    onrowdeleting="gvwSelectedPersonnel_RowDeleting">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="تاريخ استخدام">
                <ItemTemplate>
                    <uc3:persiandatebinder ID="pdbDOE0" 
                        Date='<%# DateTime.Parse(Eval("DOE").ToString()) %>' runat="server" />
                </ItemTemplate>
                <ItemStyle Wrap="False" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="شعبه محل خدمت">
